...
const studentNamespace = 'org.elss.student';
const transactionType = 'createStudent';

// Change this for populating other versions
bnUtil.cardName='admin@elss';
if(process.argv.length < 3){
    console.log("Usage: node generateSampleStudent.js <card-name> ")
...
*/
function createStudent(studentId, name, school, email, cell) {
