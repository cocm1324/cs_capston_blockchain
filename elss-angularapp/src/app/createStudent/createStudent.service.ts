...
export class createStudentService {
  ...
  private NAMESPACE = 'org.elss.student.createStudent';

  constructor(private dataService: DataService<createStudent>) {
  };
  ...
  public addTransaction(itemToAdd: any): Observable<createStudent> {
