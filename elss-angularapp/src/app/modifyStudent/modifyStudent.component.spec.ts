...
describe('modifyStudentComponent', () => {
  ...
  let mockmodifyStudentService;
  let mockDataService

  beforeEach(async(() => {

    mockmodifyStudentService = sinon.createStubInstance(modifyStudentService);
    mockmodifyStudentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: modifyStudentService, useValue: mockmodifyStudentService },
