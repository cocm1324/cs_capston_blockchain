...
export class createElectionService {
  ...
  private NAMESPACE = 'org.elss.election.createElection';

  constructor(private dataService: DataService<createElection>) {
  };
  ...
  public addTransaction(itemToAdd: any): Observable<createElection> {
