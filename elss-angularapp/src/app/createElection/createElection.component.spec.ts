...
import { createElectionComponent } from './createElection.component';
...
describe('createElectionComponent', () => {
  ...
  let mockcreateElectionService;
  let mockDataService

  beforeEach(async(() => {

    mockcreateElectionService = sinon.createStubInstance(createElectionService);
    mockcreateElectionService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createElectionService, useValue: mockcreateElectionService },
